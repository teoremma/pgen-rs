...
impl Pgen {
    ...
    pub fn from_file_path(file_path: String) -> io::Result<Pgen> {
        ...
        let main_header_body_offset = pgen.check_variant_block_offsets(pgen.variant_block_offsets_offset());
    ...
    fn check_main_header_body(&self, offset: u64) -> u64 {
        ...
        for block in 0..n_blocks {
            assert_eq!(types_reader.stream_position().unwrap(), lengths_reader.stream_position().unwrap());
            ...
            _ = lengths_reader.seek(SeekFrom::Current(types_block_size as i64)).unwrap();
            ...
            _ = types_reader.seek(SeekFrom::Start(lengths_reader_position)).unwrap();
        }
